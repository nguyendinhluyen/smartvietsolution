...
<div class="portfolio-image">
    <img src="img/boxify.png" alt="Boxify">
</div>
<div class="project-overlay">
    <div class="open-project-link">
        <a class="open-project" title="Boxify"></a>
    </div>
    <a class="project-info" href="{{ route('temp.boxify.index') }}" target="_blank">
        <div class="zoom-icon"></div>
        <h4 class="project-name">Boxify Template</h4>
